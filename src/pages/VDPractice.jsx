...
const QUESTIONS = [
  ...
  },
  {
    ...
    question: '小明要從台北去高雄，只在兩個選項之間選擇：高鐵（NT$1,490 / 1.5小時 / 準時）vs 客運（NT$350 / 4.5小時 / 較不固定）。小明選了客運。他的機會成本是什麼？',
    options: [
      'A. 他付出的NT$350票價',
      'B. 他在車上多花的3小時',
      'C. 搭高鐵可以省下的3小時，以及高鐵的準時和確定性',
      'D. 客運站離他家比較遠的麻煩',
    ],
    answer: 'C. 搭高鐵可以省下的3小時，以及高鐵的準時和確定性',
    explanation: '小明選了客運，放棄的是高鐵帶來的速度、準時和確定性。那些「因為選了客運而放棄的好處」，就是他的機會成本。注意——他付出的票價NT$350是他的成本，不是機會成本；機會成本是他沒有選到的那個選項的價值。',
  },
  {
